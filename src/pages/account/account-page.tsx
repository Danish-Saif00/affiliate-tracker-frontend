...
function ProfileForm({ profile, disabled, onSubmit }: ProfileFormProps) {
...
export function AccountPage() {
  ...
  if (account.status === "loading" || account.status === "idle") {
  ...
  return (
    <div className="control-page account-page">
      <ControlModuleHeader
        description="Manage your display preferences. Email and password credentials are controlled by your parent administrator."
        eyebrow={platformAdmin ? "Super Admin Profile" : "Personal Settings"}
        icon="manage_accounts"
        stats={[
          {
            label: "Email",
            value: profile?.email ?? auth.user?.email ?? "Unavailable",
          },
          {
            label: "Timezone",
        ...
        title={platformAdmin ? "My Profile" : "Account"}
      />
