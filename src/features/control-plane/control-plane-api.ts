...
function parseConversion(value: unknown): Conversion {
  ...
  return {
    ...
    postbackEndpointId: readNullableString(value.postbackEndpointId, 'conversion endpoint id'),
    postbackEndpointName: readNullableString(value.postbackEndpointName, 'conversion endpoint name'),
